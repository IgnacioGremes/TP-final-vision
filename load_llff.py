...
def spherify_poses(poses, bds):
    ...
    new_poses = np.concatenate([new_poses, np.broadcast_to(poses[0,:3,-1:], new_poses.shape[:,:3,-1:])], -1)
    poses_reset = np.concatenate([poses_reset[:,:3,:4], np.broadcast_to(poses[0,:3,-1:], poses_reset.shape[:,:3,-1:])], -1)
